...
import com.sarality.app.datastore.contact.ContactNumber.LabelType;
...
public class ContactDataStore extends AbstractContentResolverDataStore<ContactData> {
  ...
  private ContactDataBuilder extractContactData(ContactDataBuilder builder, long contactId, Cursor cursor) {
    final ColumnProcessors processors = new ColumnProcessors();
    final ColumnProcessor<LabelType> labelTypeProcessor = processors.forMappedEnum(LabelType.class, LabelType.values());
    ...
    if (mimeType.equals(Email.CONTENT_ITEM_TYPE)) {
      ...
      LabelType labelType = labelTypeProcessor.extract(cursor, Column.DATA2);
      if (labelType == null) {
