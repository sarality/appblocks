...
/**
 * Part of the Query Filter that defines the Column on which the filter is
 * defined and whether this is and AND or a OR filter.
 * <p>
 * The class is an interim object generated by the QueryBuilder, which can in
 * turn add a Filter to the Builder when the filter value is provided.
 * 
...
public class FilterTarget {
  ...
  /**
   * Package protected Builder since the class should only be created by the
   * Builder.
   * 
   * @param builder
   *          QueryBuilder that generated this Target
   * @param column
   *          Column that this is a Filter for
   * @param operator
   *          Operation that needs to be performed on the column.
   */
   ...
   * 
   * @param value
   *          The value that the column must be equal to
   * @return Modified QueryBuilder
   */
  public QueryBuilder equalTo(FilterValue<?> value) {
   ...
   * 
   * @param value
   *          The value that the column be must not be equal to.
   * @return Modified QueryBuilder
   */
  ...
  /**
   * Add a filter to the builder that checks if a column is null, and returns
  ...
  /**
   * Add a filter to the builder that checks if a column is not null, and
