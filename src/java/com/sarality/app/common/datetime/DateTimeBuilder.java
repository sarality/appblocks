...
public class DateTimeBuilder {
   ...
   * @return A DateTimeBuilder with the date set as the given year, month and day.
   */
  public static DateTimeBuilder date(int year, int month, int day, int hour, int minutes, int seconds) {
    return new DateTimeBuilder(new DateTime(year, month, day, hour, minutes, seconds, 0));
  }
