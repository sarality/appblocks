...
/**
 * Initializer for Contacts DataStore module.
 *
 * @author abhideep@ (Abhideep Singh)
 */
public class ContactModuleInitializer implements ModuleInitializer {
  ...
  public List<DataStore<?>> getDataStores(Application application) {
    ...
    dataStoreList.add(new ContactDataStore(application.getApplicationContext()));
    return dataStoreList;
  }

  @Override
  public void initEnumDatas(Application application) {
    // No Enum Data to initialize.
  }
}
