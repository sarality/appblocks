...
import com.sarality.app.view.action.ClickListViewItemActionPerformer;
import com.sarality.app.view.action.ViewAction;
import com.sarality.app.view.action.ViewActionTrigger;
import com.sarality.app.view.action.ViewDetail;

/**
 * Tests for {@link ClickListViewItemActionPerformer}.
 * 
...
public class ListItemClickActionPerformerTest extends TestCase {
  ...
  public void testSetupListener() {
    ...
    ClickListViewItemActionPerformer actionPerformer = new ClickListViewItemActionPerformer(action);
  ...
  public void testOnItemClick() {
    ...
    ClickListViewItemActionPerformer clickAction = new ClickListViewItemActionPerformer(action);
